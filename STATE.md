...
## In flight
- GPU queue: trippy-train-smoke-1 (EXP-0003 smoke config, prio 16) queued behind a Hunua training.
- fix/se3-exp-grad (mid): rotation gradient at phi=0.
- feat/dolly (mid): shade dolly + off-path poses + candidate-report CLI + audit wrappers.
- feat/hybrid-c (mid/high): design C render->photo refinement on gsrender outputs (EXP-0005).
- feat/brush-fork (mid): Brush fork under rust/, brush-pyramid/brush-unet crate skeletons, ADR-0005.
