...
- 2026-09-10 ADR-0008 Stage 3 (SOG export + Quest viewer): tooling built and tested, real
  ...
  **Verdict**: tooling PASS (24 new tests green, `ruff check` clean, ported to the GPU
  ...
  files `cd` into it).
- 2026-09-10T00:20:43Z delivered kkv2-5-hybrid-viewer: trippy train report kkv2-5-hybrid: epoch 139, held-out PSNR 16.85 dB (neighbours-exposure) (strict, own exposure: 14.80 dB), shade dark-mass n/a vs baseline n/a; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/kkv2-5-hybrid/OPEN_TRIPS_MAC_kkv2-5-hybrid.command)
- 2026-09-10T00:20:45Z delivered kkv2-5-hybrid-dolly: trippy train report kkv2-5-hybrid: epoch 139, held-out PSNR 16.85 dB (neighbours-exposure) (strict, own exposure: 14.80 dB), shade dark-mass n/a vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/report/dolly/dolly.mp4)
...
- 2026-09-11T00:18:32Z delivered hybrid-a-all-levels-bc-viewer: trippy train report hybrid-a-all-levels-bc: epoch 251, held-out PSNR 17.45 dB (neighbours-exposure) (strict, own exposure: 16.39 dB), shade dark-mass 38.5% vs baseline 19.9%; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/hybrid-a-all-levels-bc/OPEN_TRIPS_MAC_hybrid-a-all-levels-bc.command)
- 2026-09-11T00:18:34Z delivered hybrid-a-all-levels-bc-dolly: trippy train report hybrid-a-all-levels-bc: epoch 251, held-out PSNR 17.45 dB (neighbours-exposure) (strict, own exposure: 16.39 dB), shade dark-mass 38.5% vs baseline 19.9% (/Users/nzbirdranch/trippy/output/runs/EXP-0009-hybrid-a/hybrid-a-all-levels-bc/report/dolly/dolly.mp4)
- 2026-09-11T00:18:35Z delivered hybrid-a-all-levels-bc-honesty: trippy train report hybrid-a-all-levels-bc: epoch 251, held-out PSNR 17.45 dB (neighbours-exposure) (strict, own exposure: 16.39 dB), shade dark-mass 38.5% vs baseline 19.9% (/Users/nzbirdranch/trippy/output/runs/EXP-0009-hybrid-a/hybrid-a-all-levels-bc/report/dolly/honesty_sheet.png)
- 2026-09-11T00:18:36Z delivered hybrid-a-all-levels-bc-export: trippy train report hybrid-a-all-levels-bc: epoch 251, held-out PSNR 17.45 dB (neighbours-exposure) (strict, own exposure: 16.39 dB), shade dark-mass 38.5% vs baseline 19.9% (/Users/nzbirdranch/trippy/output/runs/EXP-0009-hybrid-a/hybrid-a-all-levels-bc/export.ply)
- 2026-09-11T00:18:40Z delivered trips-leaderboard: One table of every TRIPS run so far vs the Gaussian baseline: held-out PSNR, shade dark-mass, extent, coverage. Regenerated after every training. (/Users/nzbirdranch/trippy/output/leaderboard/leaderboard.png)

## 2026-09-11 12:22 — hybrid-a-all-levels-bc (kk-coherent, hybrid A with Gaussian channels at every pyramid level, broadcast)
- Numbers: epoch 251, held-out PSNR 17.45 dB (strict 16.39), shade dark-mass 38.5% vs Gaussians 19.9% (kk-coherent frames, correct for this scene). Compare EXP-0010 shade-prune 17.75/15.59 and alternating hold-out 17.94: comparable PSNR, much better strict number. Artifact: 4-other/hybrid-a-all-levels-bc-viewer.command. Small-scene supporting evidence for the full-scene hybrid result; not a review-queue priority.
- 2026-09-11T02:11:37Z delivered kkv2-1-full-masked-viewer: trippy train report kkv2-1-full-masked: epoch 299, held-out PSNR 14.78 dB (neighbours-exposure) (strict, own exposure: 13.01 dB), shade dark-mass 37.5% vs baseline n/a; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/kkv2-1-full-masked/OPEN_TRIPS_MAC_kkv2-1-full-masked.command)
- 2026-09-11T02:11:38Z delivered kkv2-1-full-masked-dolly: trippy train report kkv2-1-full-masked: epoch 299, held-out PSNR 14.78 dB (neighbours-exposure) (strict, own exposure: 13.01 dB), shade dark-mass 37.5% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-1-full-masked/report/dolly/dolly.mp4)
- 2026-09-11T02:11:39Z delivered kkv2-1-full-masked-honesty: trippy train report kkv2-1-full-masked: epoch 299, held-out PSNR 14.78 dB (neighbours-exposure) (strict, own exposure: 13.01 dB), shade dark-mass 37.5% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-1-full-masked/report/dolly/honesty_sheet.png)
- 2026-09-11T02:11:39Z delivered kkv2-1-full-masked-export: trippy train report kkv2-1-full-masked: epoch 299, held-out PSNR 14.78 dB (neighbours-exposure) (strict, own exposure: 13.01 dB), shade dark-mass 37.5% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-1-full-masked/export.ply)
- 2026-09-11T02:11:43Z delivered trips-leaderboard: One table of every TRIPS run so far vs the Gaussian baseline: held-out PSNR, shade dark-mass, extent, coverage. Regenerated after every training. (/Users/nzbirdranch/trippy/output/leaderboard/leaderboard.png)

## 2026-09-11 14:16 — kkv2-1-full-masked at the full 300 epochs (kkv2-8b finish)
- Numbers: epoch 299, held-out PSNR 14.78 dB (strict 13.01), dark-mass 37.5% (corrected scene+frames). At epoch 122 the same run measured 15.06 dB (strict 13.97) and 37.3%.
- Verdict: MORE EPOCHS DO NOT HELP plain TRIPS on the full scene; held-out quality drifts down after ~120 epochs (over-fitting the training views at half resolution). Answers Jordan's "is the fuzz under-training?": no. The hybrids (16.85 / 16.94 dB) are the way, not longer plain runs. This also weakens the case for the parked 3-day full-res plain run.
- Note: the report re-exported the bundle behind 4-other/kkv2-1-full-masked-viewer.command, so that launcher now shows epoch 299 (the epoch-122 bundle Jordan judged lives on in kkv2-1-combined).
- 2026-09-11T07:22:08Z delivered hybrid-a-all-levels-viewer: trippy train report hybrid-a-all-levels: epoch 87, held-out PSNR 17.26 dB (neighbours-exposure) (strict, own exposure: 16.88 dB), shade dark-mass 38.0% vs baseline 19.9%; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/hybrid-a-all-levels/OPEN_TRIPS_MAC_hybrid-a-all-levels.command)
- 2026-09-11T07:22:11Z delivered hybrid-a-all-levels-dolly: trippy train report hybrid-a-all-levels: epoch 87, held-out PSNR 17.26 dB (neighbours-exposure) (strict, own exposure: 16.88 dB), shade dark-mass 38.0% vs baseline 19.9% (/Users/nzbirdranch/trippy/output/runs/EXP-0009-hybrid-a/hybrid-a-all-levels/report/dolly/dolly.mp4)
...
- 2026-09-11T12:28:58Z delivered full3-alt-viewer: trippy train report full3-alt: epoch 86, held-out PSNR 17.89 dB (neighbours-exposure) (strict, own exposure: 17.06 dB), shade dark-mass 37.2% vs baseline 19.9%; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/full3-alt/OPEN_TRIPS_MAC_full3-alt.command)
- 2026-09-11T12:29:01Z delivered full3-alt-dolly: trippy train report full3-alt: epoch 86, held-out PSNR 17.89 dB (neighbours-exposure) (strict, own exposure: 17.06 dB), shade dark-mass 37.2% vs baseline 19.9% (/Users/nzbirdranch/trippy/output/runs/EXP-0003-kk-trips-train/full3-alt/report/dolly/dolly.mp4)
...
- 2026-09-11T19:37:33Z delivered kkv2-6-shade-prune-viewer: trippy train report kkv2-6-shade-prune: epoch 104, held-out PSNR 15.06 dB (neighbours-exposure) (strict, own exposure: 14.11 dB), shade dark-mass 31.9% vs baseline n/a; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/kkv2-6-shade-prune/OPEN_TRIPS_MAC_kkv2-6-shade-prune.command)
- 2026-09-11T19:37:36Z delivered kkv2-6-shade-prune-dolly: trippy train report kkv2-6-shade-prune: epoch 104, held-out PSNR 15.06 dB (neighbours-exposure) (strict, own exposure: 14.11 dB), shade dark-mass 31.9% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-6-shade-prune/report/dolly/dolly.mp4)
- 2026-09-11T19:37:38Z delivered kkv2-6-shade-prune-honesty: trippy train report kkv2-6-shade-prune: epoch 104, held-out PSNR 15.06 dB (neighbours-exposure) (strict, own exposure: 14.11 dB), shade dark-mass 31.9% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-6-shade-prune/report/dolly/honesty_sheet.png)
- 2026-09-11T19:37:40Z delivered kkv2-6-shade-prune-export: trippy train report kkv2-6-shade-prune: epoch 104, held-out PSNR 15.06 dB (neighbours-exposure) (strict, own exposure: 14.11 dB), shade dark-mass 31.9% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-6-shade-prune/export.ply)
- 2026-09-11T19:37:45Z delivered trips-leaderboard: One table of every TRIPS run so far vs the Gaussian baseline: held-out PSNR, shade dark-mass, extent, coverage. Regenerated after every training. (/Users/nzbirdranch/trippy/output/leaderboard/leaderboard.png)

## 2026-09-12 07:44 — kkv2-6-shade-prune (full scene, audit-aligned prune; run for completeness after Jordan rejected the approach)
- Numbers: epoch 104, held-out PSNR 15.06 dB (strict 14.11), dark-mass 31.9% (corrected scene+frames) vs plain TRIPS 37.3% and Gaussians 26.7%. Same PSNR as plain TRIPS; lower dark mass because it deletes the geometry under the tree, which is exactly what Jordan rejected on the small scene ("nothing behind the cloud"). Not a candidate. Launcher self-delivered for the record.
- 2026-09-12T00:26:20Z delivered removal-rel-viewer: trippy train report removal-rel: epoch 299, held-out PSNR 17.69 dB (neighbours-exposure) (strict, own exposure: 16.52 dB), shade dark-mass 36.6% vs baseline 19.9%; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/removal-rel/OPEN_TRIPS_MAC_removal-rel.command)
- 2026-09-12T00:26:21Z delivered removal-rel-dolly: trippy train report removal-rel: epoch 299, held-out PSNR 17.69 dB (neighbours-exposure) (strict, own exposure: 16.52 dB), shade dark-mass 36.6% vs baseline 19.9% (/Users/nzbirdranch/trippy/output/runs/EXP-0010-point-removal/removal-rel/report/dolly/dolly.mp4)
...
- 2026-09-12T05:13:34Z delivered union-broadcast-viewer: trippy train report union-broadcast: epoch 299, held-out PSNR 17.25 dB (neighbours-exposure) (strict, own exposure: 16.19 dB), shade dark-mass 36.3% vs baseline n/a; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/union-broadcast/OPEN_TRIPS_MAC_union-broadcast.command)
- 2026-09-12T05:13:36Z delivered union-broadcast-dolly: trippy train report union-broadcast: epoch 299, held-out PSNR 17.25 dB (neighbours-exposure) (strict, own exposure: 16.19 dB), shade dark-mass 36.3% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0006-union/union-broadcast/report/dolly/dolly.mp4)
...
- 2026-09-12T10:19:29Z delivered union-trips-viewer: trippy train report union-trips: epoch 87, held-out PSNR 16.72 dB (neighbours-exposure) (strict, own exposure: 16.40 dB), shade dark-mass 35.8% vs baseline n/a; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/union-trips/OPEN_TRIPS_MAC_union-trips.command)
- 2026-09-12T10:19:32Z delivered union-trips-dolly: trippy train report union-trips: epoch 87, held-out PSNR 16.72 dB (neighbours-exposure) (strict, own exposure: 16.40 dB), shade dark-mass 35.8% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0006-union/union-trips/report/dolly/dolly.mp4)
- 2026-09-12T10:19:34Z delivered union-trips-honesty: trippy train report union-trips: epoch 87, held-out PSNR 16.72 dB (neighbours-exposure) (strict, own exposure: 16.40 dB), shade dark-mass 35.8% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0006-union/union-trips/report/dolly/honesty_sheet.png)
- 2026-09-12T10:19:37Z delivered union-trips-export: trippy train report union-trips: epoch 87, held-out PSNR 16.72 dB (neighbours-exposure) (strict, own exposure: 16.40 dB), shade dark-mass 35.8% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0006-union/union-trips/export.ply)
- 2026-09-12T10:19:42Z delivered trips-leaderboard: One table of every TRIPS run so far vs the Gaussian baseline: held-out PSNR, shade dark-mass, extent, coverage. Regenerated after every training. (/Users/nzbirdranch/trippy/output/leaderboard/leaderboard.png)

## 2026-09-12 22:26 — union-trips (kk-coherent, union source, trips mode) — last queued run
- Numbers: epoch 87 (budget), held-out PSNR 16.72 dB, strict 16.40 dB, dark-mass 35.8%. Union source: no gain in either mode. The trippy GPU queue is now empty.
- Queued next (prio 50, behind Splats' 30): kkv2-7b-hybrid-gate-cont and kkv2-5c-hybrid-cont, continuations of the two best full-scene arms, to learn whether hybrids also peak early like plain TRIPS did (15.06 at ep 122 -> 14.78 at ep 299).
- 2026-09-12T10:27:28Z submitted job trippy-kkv2-7b-hybrid-gate-cont prio 50: bash -c cd /Users/nzbirdranch/trippy/.worktrees/blend-gate && PYTHONPATH=. TRIPPY_OUTPUT=/Users/nzbirdranch/trippy/output /Users/nzbirdranch/trippy/.venv/bin/python -m trippy.cli train --config /Users/nzbirdranch/trippy/.worktrees/blend-gate/experiments/EXP-0011-karekare-v2/config_hybrid_gate.yaml --resume /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-7-hybrid-gate/checkpoints/checkpoint_latest.pt --device mps --max-minutes 600 --report
- 2026-09-12T10:27:28Z submitted job trippy-kkv2-5c-hybrid-cont prio 50: bash -c PYTHONPATH=. TRIPPY_OUTPUT=/Users/nzbirdranch/trippy/output /Users/nzbirdranch/trippy/.venv/bin/python -m trippy.cli train --config experiments/EXP-0011-karekare-v2/config_hybrid.yaml --resume /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/checkpoints/checkpoint_latest.pt --device mps --max-minutes 600 --report

## 2026-09-13 09:45 — kkv2-5c-hybrid-cont killed in its wrap-up (second time this pattern)
- Training ran its 600-min budget cleanly to epoch 244 (checkpoint_latest 08:29); the process was Killed: 9 at 09:30 during the post-training wrap-up (eval/report; no export-bundle line reached). kkv2-8 died the same way at epoch 259. The kill is not the runner (no timeout rule in runner.sh) -> almost certainly memory pressure in the wrap-up on the 7.5M-point full scene. Fix in flight; the epoch-244 checkpoint is intact and a report-only job follows.
- 2026-09-12T21:58:26Z submitted job trippy-kkv2-5-hybrid-report prio 40: trippy report-from-checkpoint /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid --memory-log /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/report/memory.jsonl

## 2026-09-13 — why `train --report` gets killed after a long run, and the staged wrap-up (fix/report-wrapup-memory)
- Question: what kills `trippy train --report` ~1 h after a successful full-scene training, and how do we get kkv2-5-hybrid's epoch-244 report out?
- Evidence: `Killed: 9` = macOS jetsam (Splats' `runner.sh` has no timeout). kkv2-5c-hybrid-cont wrote `report/dolly/{dolly.mp4,honesty_sheet.png,metrics.json}` at 08:36 and never rewrote `report/offpath/` (still 2026-09-10), so it died inside the OFF-PATH candidate render, ~54 min in, at 09:30. Same shape as kkv2-8-full-masked-cont (ep 259, 2026-09-11 08:07). 400-420 min runs on the same scene finish the same wrap-up.
- Root cause: the wrap-up ran with the finished Trainer resident (7.5M points + Adam state + 756-image dataset + U-Net) while `render_candidate` builds a SECOND Trainer from the same checkpoint per pose set — the run log prints the Trainer-construction banner twice AFTER `exported 7542137 points` — plus a live gsrender of kklid_20000, on top of an MPS allocator cache grown over 10 h of training (the part that scales with training length).
- Numbers (CPU, synthetic, `feature_channels=4`; params+grads+Adam only): 100k pts 0.014 G, 400k 0.054 G, 1.6M 0.215 G — linear, so ~1.0 G at 7.5M for that component alone. Real MPS driver-allocated figures: PENDING, from the job below.
- Numbers (CPU, synthetic e2e, `train --report`, wrap-up peak RSS from `report/memory.jsonl`): 2 epochs 0.406 G, 12 epochs 0.409 G (+0.7% for 6x the training). Peak no longer tracks training length. (Same scene is too small for the absolute saving to show: old code measured 0.406/0.414 G externally.)
- Fix: `Trainer.release_for_report()` (drops optimizer/points/dataset/net, then gc + `torch.mps.empty_cache()`), the wrap-up as a stage list (`eval`, `dolly`, `offpath`, `audits`, `bundle`, `finalize`) with a release and a memory sample per boundary, and a partial result per stage in `<run_dir>/report/stages/`. New `trippy report-from-checkpoint <run_dir>` runs that same path from a run directory alone.
- Job: `trippy-kkv2-5-hybrid-report` (prio 40) — the missing epoch-244 report for kkv2-5-hybrid, memory log at `output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/report/memory.jsonl`. Queued behind the running kkv2-7b-hybrid-gate-cont (prio 50, ~9 h).
...
- 2026-09-13T08:35:38Z delivered kkv2-5-hybrid-viewer: trippy train report kkv2-5-hybrid: epoch 244, held-out PSNR 16.92 dB (neighbours-exposure) (strict, own exposure: 14.15 dB), shade dark-mass 33.4% vs baseline n/a; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/output/deliver/kkv2-5-hybrid/OPEN_TRIPS_MAC_kkv2-5-hybrid.command)
- 2026-09-13T08:35:38Z delivered kkv2-5-hybrid-dolly: trippy train report kkv2-5-hybrid: epoch 244, held-out PSNR 16.92 dB (neighbours-exposure) (strict, own exposure: 14.15 dB), shade dark-mass 33.4% vs baseline n/a (/Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/report/dolly/dolly.mp4)
...
## 2026-09-13 (later) — recover the two hybrids' BEST epochs, not just their latest
- Question: the ep-225/ep-244 continuations above re-exported `kkv2-7-hybrid-gate-viewer.command` and `kkv2-5-hybrid-viewer.command` at their new (worse, strict-PSNR-drifted) epochs, overwriting the earlier, better bundles. Both runs still have `checkpoint_best.pt` on disk (gate: ep 120, strict 16.62, the project's best overall; hybrid A: ep 140, strict 14.80). How to get Jordan a launcher for those without re-running training or clobbering the current (also useful, higher neighbour-PSNR) launchers?
- Fix (feat/best-epoch-launchers): `trippy report-from-checkpoint` gained `--checkpoint <path>` and `--report-dir <path>`. `report_context_from_run_dir` now treats an explicit checkpoint different from `checkpoint_latest.pt` as an override: it builds a fresh `export_ep<N>.ply` from THAT checkpoint (never the stale top-level `export.ply`, which describes the latest epoch), tags the bundle/launcher/delivery name `<run>-ep<N>` end to end, and writes everything under `--report-dir` instead of `<run_dir>/report`/`bundle`.
- Verification: new test `test_cli_report_from_checkpoint_with_checkpoint_and_report_dir_does_not_overwrite_latest` (tests/test_cli_train_report.py) trains once with `--report` (producing the normal latest-epoch report/bundle), then runs `report-from-checkpoint --checkpoint --report-dir` against a copied checkpoint and asserts the original report.json/bundle.json are byte-identical afterward, and the new one lands under the separate dir with the epoch in every name. Full Python suite: 1325 passed, 10 skipped (same pre-existing web_build_script npm/wasm-pack failures as every prior session -- this worktree has no `brush-trips` submodule checked out, so `cargo check`/wasm toolchain checks can't run here at all; unrelated to this change).
- Jobs (prio 40, queued behind whatever the gpu queue already had):
- 2026-09-13T08:48:09Z submitted job trippy-kkv2-7-gate-best-report prio 40: /Users/nzbirdranch/trippy/.venv/bin/python -m trippy.cli report-from-checkpoint /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-7-hybrid-gate --device mps --checkpoint /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-7-hybrid-gate/checkpoints/checkpoint_best.pt --report-dir /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-7-hybrid-gate/report_best --memory-log /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-7-hybrid-gate/report_best/memory.jsonl
- 2026-09-13T08:48:15Z submitted job trippy-kkv2-5-hybrid-best-report prio 40: /Users/nzbirdranch/trippy/.venv/bin/python -m trippy.cli report-from-checkpoint /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid --device mps --checkpoint /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/checkpoints/checkpoint_best.pt --report-dir /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/report_best --memory-log /Users/nzbirdranch/trippy/output/runs/EXP-0011-karekare-v2/kkv2-5-hybrid/report_best/memory.jsonl
- Caveat: both job files `exec /Users/nzbirdranch/trippy/.venv/bin/python -m trippy.cli ...` against the MAIN checkout, which does not have `--checkpoint`/`--report-dir` until `feat/best-epoch-launchers` is reviewed and merged -- they will fail with an argparse "unrecognized arguments" error if they run before that merge lands. Orchestrator: merge before (or hold) these two.
- Verdict: PENDING (their own report.json/rc files are the measurement; expected numbers: gate ep120 strict ~16.62, hybrid A ep140 strict ~14.80, matching the ep-103/ep-139 reports already on record).
- Artifact path (once the jobs land): `output/runs/EXP-0011-karekare-v2/kkv2-7-hybrid-gate/report_best/` and `.../kkv2-5-hybrid/report_best/`, delivered as `kkv2-7-hybrid-gate-ep120-viewer`/`kkv2-5-hybrid-ep140-viewer` (exact epoch number confirmed once the checkpoint's own payload is read).
- 2026-09-13T09:42:52Z delivered kkv2-5-hybrid-ep140-viewer: trippy train report kkv2-5-hybrid-ep140: epoch 140, held-out PSNR 16.82 dB (neighbours-exposure) (strict, own exposure: 14.79 dB), shade dark-mass 34.0% vs baseline 26.7%; open in the free-navigation viewer; N/P step capture views (/Users/nzbirdranch/trippy/.worktrees/best-launchers/output/deliver/kkv2-5-hybrid-ep140/OPEN_TRIPS_MAC_kkv2-5-hybrid-ep140.command)
- 2026-09-13T09:42:52Z delivered trips-leaderboard: One table of every TRIPS run so far vs the Gaussian baseline: held-out PSNR, shade dark-mass, extent, coverage. Regenerated after every training. (/Users/nzbirdranch/trippy/.worktrees/best-launchers/output/leaderboard/leaderboard.png)

## 2026-09-13 21:46 — best-epoch launchers
- trippy-kkv2-5-hybrid-best-report rc=0: hybrid A at its best checkpoint (epoch 140): 16.82 dB, strict 14.79, dark-mass 34.0%. Launcher 4-other/kkv2-5-hybrid-ep140-viewer.command (the un-tagged launcher shows the drifted ep 244).
- trippy-kkv2-7-gate-best-report rc=1: the job ran inside the stale .worktrees/blend-gate checkout (no trippy.render.leaderboard there). Requeued as kkv2-7-gate-best-report2 against main (configs identical apart from comments).
